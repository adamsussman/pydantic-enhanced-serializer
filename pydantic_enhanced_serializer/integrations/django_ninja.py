...
from django_ninja.renderes import JSONRenderer
...
class PydanticFieldSetsRenderer(JSONRenderer):
    ...
    def pydantic_to_dict(
        ...
        *,
        ...
        parser = Parser()
        fieldsets = (
            parser.parse_body(request).get(self.fields_parameter_name) or
            parser.parse_querydict(request.GET).get(self.fields_parameter_name) or
            []
        )
